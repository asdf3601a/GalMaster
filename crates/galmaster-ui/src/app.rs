use crate::llm_settings::{
    ui_api_key_field, ui_context_settings, ui_sampling_settings, ui_structured_output_for_stage,
};
...
impl GalMasterApp {
    ...
    fn ui_vision_settings(&mut self, ui: &mut egui::Ui) {
        ...
        ui.group(|ui| {
            ...
            ui.separator();
            ui_structured_output_for_stage(ui, &mut self.config.pipeline.vision);
